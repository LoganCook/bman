...
urlpatterns = [
    ...
    url(r'^(?i)api/product/pricelist/$', views.Pricelist.as_view(), name='api-pricelist'),  # Product price list
    url(r'^(?i)api/product/substitute/$', views.SubstituteList.as_view(), name='api-substitute'),  # Product substitute list
]
